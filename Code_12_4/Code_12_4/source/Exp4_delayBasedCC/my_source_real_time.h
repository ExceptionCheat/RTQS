...
#ifndef MY_REAL_TIME_SOURCE_H
#define MY_REAL_TIME_SOURCE_H
...
// #include "MySourceIDPerHopDelay.h"
#include "MySourceIDType.h"
#include "ns3/core-module.h"

using namespace ns3;

class MyRealTimeSource : public Application 
{
public:
  static TypeId GetTypeId (void);

  MyRealTimeSource ();
  virtual ~MyRealTimeSource();

...
protected:
  ...
  // Flow identifier K (CSourceIDTag value, 1:1 mapping to 5-tuple) to byte count V
...
class CSourceIDTagFBD: public FlowBottleneckDetector<uint32_t, uint64_t>
{
public:

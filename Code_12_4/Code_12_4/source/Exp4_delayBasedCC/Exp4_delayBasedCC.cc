...
int main (int argc, char *argv[])
{
  ...
  NS_LOG_COMPONENT_DEFINE("Exp4_delayBasedCC");
  ...
  std::string delay[num_leaf]={"1ms","1ms","1ms","1ms"};    //Link delay of leaf nodes.
  ...
  std::string p2p_cca[num_leaf] = {"ns3::TcpBbr",               // The congestion control algorithm used by each leaf node.
                                    "ns3::TcpCubic",            // Options: ns3::TcpCubic, ns3::TcpNewReno, ns3::TcpLinuxReno, ns3::TcpBbr, ns3::TcpVegas ...
                                    "ns3::TcpCubic",
                                    "ns3::TcpBbr"};
  ...
  std::string qlog_dir="/home/xuzhenge/Desktop/Result_exp4/test/";   // Output file (qlog file) dictionary.

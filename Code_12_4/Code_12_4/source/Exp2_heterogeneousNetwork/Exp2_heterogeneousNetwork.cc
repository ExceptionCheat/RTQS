...
#include "Exp2_heterogeneousNetwork.h"
...
int main (int argc, char *argv[])
{
  ...
  NS_LOG_COMPONENT_DEFINE("Exp2_heterogeneousNetwork");
  ...
  std::string delay[num_leaf]={"1ms","10ms","90ms","50ms"};     //Link delay of leaf nodes.
  ...
  std::string qlog_dir="/home/xuzhenge/Desktop/Result_exp2/";   // Output file (qlog file) dictionary.

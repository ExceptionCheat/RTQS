...
#include "Exp1_symmetryNetwork.h"
...
int main (int argc, char *argv[])
{
  ...
  NS_LOG_COMPONENT_DEFINE("Exp1_symmetryNetwork");
  ...
  std::string qlog_dir="/home/xuzhenge/Desktop/Result_exp1/";   // Output file (qlog file) dictionary.
